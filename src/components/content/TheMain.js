			...
			<div className="relative pt-[24px] pb-[48px] px-[32px] space-y-9 max-w-screen-5xl">
					...
					<div className="flex flex-wrap justify-between items-end gap-x-6 mb-[18px]">
						<div>
							<h2 className="text-2xl font-semibold hover:underline capitalize">
								<a href="/User files/React_lessons/react_spotify/public">Lorem ipsum dolor sit</a>
							</h2>
						</div>
				...
				<div>
					<div className="flex flex-wrap justify-between items-end gap-x-6 mb-[18px]">
						<div>
							<h2 className="text-2xl font-semibold hover:underline capitalize">
								<a href="/User files/React_lessons/react_spotify/public">Lorem ipsum dolor</a>
							</h2>
				...
				<div>
					<div className="flex flex-wrap justify-between items-end gap-x-6 mb-[18px]">
						<div>
							<h2 className="text-2xl font-semibold hover:underline capitalize">
								<a href="/User files/React_lessons/react_spotify/public">Lorem ipsum</a>
							</h2>
